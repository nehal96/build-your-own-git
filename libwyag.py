...
# The syntax of `git cat-file` is just two positional arguments: a type and a
# object identifier
...
# hash-object is basically the opposite of cat-file: it reads a file, computes
# its hash as an object, either storing it in the repo (if -w flag is passed) or
# just printing the hash
